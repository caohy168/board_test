...
wire   [0:0] tmp_user_V_load_load_fu_380_p1;
wire   [0:0] tmp_last_V_fu_383_p2;
reg   [0:0] tmp_last_V_reg_619;
...
wire   [23:0] p_Result_s_fu_439_p3;
wire   [23:0] p_Result_4_fu_431_p3;
wire   [7:0] select_ln941_2_fu_461_p3;
wire   [7:0] select_ln941_1_fu_454_p3;
wire   [23:0] select_ln941_fu_447_p3;
wire   [15:0] tmp_4_fu_468_p3;
wire   [0:0] fid_toggle_fu_415_p1;
wire   [0:0] and_ln983_fu_489_p2;
wire   [0:0] fid_toggle_1_fu_499_p2;
wire   [0:0] or_ln983_1_fu_494_p2;
wire   [0:0] select_ln996_fu_505_p3;
reg   [4:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
system_v_tpg_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_258(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
system_v_tpg_0_0_reg_unsigned_short_s grp_reg_unsigned_short_s_fu_264(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state3) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln893_fu_354_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state4) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((icmp_ln893_fu_354_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln898_fu_369_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (tmp_user_V_load_load_fu_380_p1 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln893_fu_354_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0))) begin
        j_0_reg_247 <= 16'd0;
    end else if (((icmp_ln898_fu_369_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        j_0_reg_247 <= j_fu_374_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln898_reg_606 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln898_fu_369_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_last_V_reg_619 <= tmp_last_V_fu_383_p2;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0) & (icmp_ln893_fu_354_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln898_reg_606 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        ap_sig_allocacmp_tmp_user_V_load = tmp_user_V_fu_152;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln898_fu_369_p2 == 1'd1)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln898_fu_369_p2 == 1'd1)))) begin
...
assign and_ln983_fu_489_p2 = (xor_ln983_fu_325_p2 & fid_toggle_fu_415_p1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln898_reg_606 == 1'd0) & (io_acc_block_signal_op62 == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((icmp_ln898_reg_606 == 1'd0) & (io_acc_block_signal_op62 == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state6_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state5_io) | ((icmp_ln898_reg_606 == 1'd0) & (io_acc_block_signal_op62 == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state5_io = ((icmp_ln898_reg_606 == 1'd0) & (m_axis_video_TREADY_int == 1'b0));
end

always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((icmp_ln898_reg_606 == 1'd0) & (io_acc_block_signal_op62 == 1'b0));
end

always @ (*) begin
    ap_block_state6_io = ((icmp_ln898_reg_606_pp0_iter1_reg == 1'd0) & (m_axis_video_TREADY_int == 1'b0));
end
...
assign fid = ((icmp_ln983_1_fu_337_p2[0:0] === 1'b1) ? or_ln983_1_fu_494_p2 : select_ln996_fu_505_p3);

assign fid_toggle_1_fu_499_p2 = (fid_toggle_fu_415_p1 ^ 1'd1);

assign fid_toggle_fu_415_p1 = counter_loc_0_fu_156[0:0];
...
assign m_axis_video_TDATA_int = {{tmp_4_fu_468_p3}, {select_ln941_fu_447_p3[7:0]}};

assign m_axis_video_TVALID = regslice_both_AXI_video_strm_V_data_V_U_vld_out;

assign or_ln983_1_fu_494_p2 = (xor_ln983_1_fu_331_p2 | and_ln983_fu_489_p2);

assign or_ln983_fu_319_p2 = (icmp_ln987_fu_291_p2 | icmp_ln983_fu_285_p2);

assign p_Result_4_fu_431_p3 = {{16'd65535}, {strmPix_V_val_0_V_dout}};

assign p_Result_s_fu_439_p3 = {{16'd65535}, {strmPix_V_val_1_V_dout}};

assign select_ln941_1_fu_454_p3 = ((icmp_ln941_fu_343_p2[0:0] === 1'b1) ? strmPix_V_val_2_V_dout : strmPix_V_val_1_V_dout);

assign select_ln941_2_fu_461_p3 = ((icmp_ln941_fu_343_p2[0:0] === 1'b1) ? strmPix_V_val_0_V_dout : strmPix_V_val_2_V_dout);

assign select_ln941_fu_447_p3 = ((icmp_ln941_fu_343_p2[0:0] === 1'b1) ? p_Result_s_fu_439_p3 : p_Result_4_fu_431_p3);

assign select_ln996_fu_505_p3 = ((icmp_ln996_fu_297_p2[0:0] === 1'b1) ? fid_toggle_1_fu_499_p2 : and_ln1001_fu_309_p2);

assign tmp_4_fu_468_p3 = {{select_ln941_2_fu_461_p3}, {select_ln941_1_fu_454_p3}};

assign tmp_last_V_fu_383_p2 = ((zext_ln898_fu_365_p1 == add_ln915_reg_560) ? 1'b1 : 1'b0);

assign tmp_user_V_load_load_fu_380_p1 = ap_sig_allocacmp_tmp_user_V_load;
