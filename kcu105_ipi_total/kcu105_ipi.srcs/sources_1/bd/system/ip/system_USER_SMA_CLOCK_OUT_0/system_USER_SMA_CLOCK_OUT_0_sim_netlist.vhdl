...
-- Command     : write_vhdl -force -mode funcsim -rename_top system_USER_SMA_CLOCK_OUT_0 -prefix
--               system_USER_SMA_CLOCK_OUT_0_ system_REC_CLOCK_OUT_0_sim_netlist.vhdl
...
entity system_USER_SMA_CLOCK_OUT_0_util_ds_buf is
  port (
  ...
  attribute C_BUFGCE_DIV of system_USER_SMA_CLOCK_OUT_0_util_ds_buf : entity is 1;
  attribute C_BUFG_GT_SYNC : integer;
  attribute C_BUFG_GT_SYNC of system_USER_SMA_CLOCK_OUT_0_util_ds_buf : entity is 0;
  attribute C_BUF_TYPE : string;
  attribute C_BUF_TYPE of system_USER_SMA_CLOCK_OUT_0_util_ds_buf : entity is "OBUFDS";
  attribute C_SIM_DEVICE : string;
  attribute C_SIM_DEVICE of system_USER_SMA_CLOCK_OUT_0_util_ds_buf : entity is "VERSAL_AI_CORE_ES1";
  attribute C_SIZE : integer;
  attribute C_SIZE of system_USER_SMA_CLOCK_OUT_0_util_ds_buf : entity is 1;
end system_USER_SMA_CLOCK_OUT_0_util_ds_buf;

architecture STRUCTURE of system_USER_SMA_CLOCK_OUT_0_util_ds_buf is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_USER_SMA_CLOCK_OUT_0 is
  port (
    OBUF_IN : in STD_LOGIC_VECTOR ( 0 to 0 );
    OBUF_DS_P : out STD_LOGIC_VECTOR ( 0 to 0 );
    OBUF_DS_N : out STD_LOGIC_VECTOR ( 0 to 0 )
  ...
  attribute NotValidForBitStream of system_USER_SMA_CLOCK_OUT_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_USER_SMA_CLOCK_OUT_0 : entity is "system_REC_CLOCK_OUT_0,util_ds_buf,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of system_USER_SMA_CLOCK_OUT_0 : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of system_USER_SMA_CLOCK_OUT_0 : entity is "util_ds_buf,Vivado 2019.2";
end system_USER_SMA_CLOCK_OUT_0;

architecture STRUCTURE of system_USER_SMA_CLOCK_OUT_0 is
  ...
  attribute x_interface_parameter of OBUF_DS_N : signal is "XIL_INTERFACENAME OBUF_DS_N, FREQ_HZ 156250000, PHASE 0.0, CLK_DOMAIN /CLOCK_COUNTER/clk_wiz_0_clk_out1, INSERT_VIP 0";
  attribute x_interface_info of OBUF_DS_P : signal is "xilinx.com:signal:clock:1.0 OBUF_DS_P CLK";
  attribute x_interface_parameter of OBUF_DS_P : signal is "XIL_INTERFACENAME OBUF_DS_P, FREQ_HZ 156250000, PHASE 0.0, CLK_DOMAIN /CLOCK_COUNTER/clk_wiz_0_clk_out1, INSERT_VIP 0";
  attribute x_interface_info of OBUF_IN : signal is "xilinx.com:signal:clock:1.0 OBUF_IN CLK";
  attribute x_interface_parameter of OBUF_IN : signal is "XIL_INTERFACENAME OBUF_IN, FREQ_HZ 156250000, PHASE 0.0, CLK_DOMAIN /CLOCK_COUNTER/clk_wiz_0_clk_out1, INSERT_VIP 0";
begin
U0: entity work.system_USER_SMA_CLOCK_OUT_0_util_ds_buf
     port map (
      BUFGCE_CE(0) => '0',
      BUFGCE_CLR(0) => '0',
      BUFGCE_I(0) => '0',
