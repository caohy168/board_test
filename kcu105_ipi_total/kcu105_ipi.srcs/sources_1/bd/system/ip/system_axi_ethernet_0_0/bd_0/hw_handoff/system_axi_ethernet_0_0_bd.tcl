...
proc create_root_design { parentCell } {
  ...
  set clk625_out [ create_bd_port -dir O -type clk clk625_out ]
  set idelay_rdy_out [ create_bd_port -dir O idelay_rdy_out ]
  ...
  connect_bd_net -net mac_speedis10100 [get_bd_pins eth_buf/speed_is_10_100] [get_bd_pins mac/speedis10100] [get_bd_pins pcs_pma/speed_is_10_100]
  ...
  connect_bd_net -net pcs_pma_clk625_out [get_bd_ports clk625_out] [get_bd_pins pcs_pma/clk625_out]
  connect_bd_net -net pcs_pma_idelay_rdy_out [get_bd_ports idelay_rdy_out] [get_bd_pins pcs_pma/idelay_rdy_out]
  ...
  connect_bd_net -net pcs_pma_sgmii_clk_en [get_bd_pins eth_buf/RX_CLK_ENABLE_IN] [get_bd_pins mac/clk_enable] [get_bd_pins pcs_pma/sgmii_clk_en]
