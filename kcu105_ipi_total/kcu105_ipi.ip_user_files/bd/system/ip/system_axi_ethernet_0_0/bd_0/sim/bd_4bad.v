...
module bd_4bad
  ...
  bd_4bad_pcs_pma_0 pcs_pma
       (.an_adv_config_val(1'b0),
        ...
        .gmii_tx_er(mac_gmii_TX_ER),
        .gmii_txd(mac_gmii_TXD),
        .idelay_rdy_out(pcs_pma_idelay_rdy_out),
        .mdc(mac_mdc),
        .mdio_i(mac_mdio_o),
