...
#
# Generated by Vivado on Fri May 08 17:03:43 +0800 2020
...
# Script info
echo -e "ila_ddr.sh - Script generated by export_simulation (Vivado v2019.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_ddr xil_defaultlib.ila_ddr xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_ddr -key {Behavioral:sim_1:Functional:ila_ddr} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_9054.protoinst" -log simulate.log
}
